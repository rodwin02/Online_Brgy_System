                ...
                <tr>
                  ...
                  <td>
                    <?php if($row['documentFor'] === 'Self') { ?>
                      <a href="./generate/certOfIndigency_generate_forself.php?id=<?= $row['id'] ?>" class="print">Print</a>
                    <?php } else {?>
                      <a href="./generate/certOfIndigency_generate_forsomeone.php?id=<?= $row['id'] ?>" class="print">Print</a>
                    <?php } ?>
