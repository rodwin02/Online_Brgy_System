        ...
        <table class="addResidentsTable">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="placeBirth[]" oninput="this.value = this.value.toUpperCase()" required></td>
                    ...
                    <td><div class="DeleteBtn" onclick="deleteRow(this)">Delete</div></td>
                </tr>
...
<script>
    ...
    function addRow() {
        ...
        var columns = ["lastName", "firstName", "middleName", "ext", "no", "streetName", "subdiName", "dateBirth", "placeBirth", "sex", "civilStatus", "citizenship", "occupational", "householdHead"];
        ...
        for (var i = 0; i < columns.length; i++) {
            ...
            if (columns[i] === "sex" || columns[i] === "civilStatus") {
                ...
                input.value = document.querySelector("table tbody tr:first-child td:nth-child(" + (i + 1) + ") input").value;
