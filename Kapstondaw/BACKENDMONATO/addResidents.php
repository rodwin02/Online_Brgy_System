     ...
     <div class="home_residents">
        ...
        <div class="household-cont">
          ...
          <div class="household-inner-cont">
            ...
            <form action="#" class="household-form">
              <div class="left-hold-cont">
                  ...
                  <div class="input-container">
                    ...
                    <input type="text" id="middleName" class="middleName">
                  </div>
                  <div class="input-container">
                  ...
                  <div class="input-container">
                    ...
                    <input type="text" id="pob" name="pob" class="pob" required>
                </div>
              </div>
              <div class="right-hold-cont">
                <div class="input-container">
                  <label for="address">Address:</label>
                   <input type="text" id="houseNo" class="houseNo" placeholder="house no.">
                   <input type="text" id="streetNo" class="streetNo" placeholder="street no.">
                ...
                <div class="input-container">
                  <label for="civilStatus">Civil Status:</label>
                    <select name="civilStatus" id="civilStatus" class="civilStatus">
                      <option value=""></option>
