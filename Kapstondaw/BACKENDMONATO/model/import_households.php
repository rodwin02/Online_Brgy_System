...
foreach ($data as $key => $row) {
    ...
    if($result->num_rows == 0) {
        $query = "INSERT INTO tbl_households (`firstname`, `middlename`, `lastname`, `sex`, `house_no`, `street`, `subdivision`, `date_of_birth`, `place_of_birth`, `civil_status`, `occupation`, `email`, `contact_no`, `voter_status`, `citizenship`, `household_no`, `osy`, `pwd`, `household_head`, `ext`) 
             VALUES ('$firstname', '$middlename', '$lastname', '$sex', '$houseNo', '$street', '$subdivision', '$dob', '$pob', '$civil_status', '$occupation', '$email', '$contactNo', '$voter_status', '$citizenship', '$householdNo', '$osy', '$pwd', '$household_head', '$ext')";
