...
$headName = $householdData['firstname'] . " " . $householdData['middlename'] . " " . $householdData['lastname'];
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if($row['household_head'] == $headName) { ?>
                            <td><input type="radio" checked name="householdHead[]" id=""></td>
                        <?php } else { ?>
                            <td><input type="radio"  name="householdHead[]" id=""></td>
                        <?php }?>
