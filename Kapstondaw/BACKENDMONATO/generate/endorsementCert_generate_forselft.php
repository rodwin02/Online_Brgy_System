...
<head>
    ...
    <title>Generate Endorsement Certificate For Self</title>
...
<body>
    ...
    <div class="printing-container-endorsement">
        <div class="title-cont">
            <p>Generate Endorsement Certificate For Self</p>
            <a href="#">Logout</a>
        </div>
        ...
        <div class="print-title">
            ...
            <div class="left-title">
                ...
                onclick="editEndorsementCert(this)"
                    ...
                    data-applicant_suffix="<?= $ecertificate['applicant_suffix']?>" data-house_no="<?= $ecertificate['house_no']?>"
        ...
        height: 133px;">
         ...
         height: auto;">
          ...
          margin-top: 30px;">To: <span style=" color: #000;
            ...
            font-style: normal;
            font-weight: 700;
            line-height: normal;">RAUL REX D. MANGUBAT</span></p>
          ...
          margin-top: 30px;
          margin-left: 85px;"><span>In this regard, I would like to endorse him to your office for
