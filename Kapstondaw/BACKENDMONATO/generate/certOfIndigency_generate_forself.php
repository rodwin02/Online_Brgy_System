...
<head>
    ...
    <title>Generate Certificate of Indigency For Self</title>
...
<body>
    ...
    <div class="printing-container-indigency">
        <div class="title-cont">
            <p>Generate Certificate of Indigency For Self</p>
            <a href="#">Logout</a>
        </div>
                ...
                height: auto;">
                    ...
                    padding: 10px;">
                        ...
                        margin-top: 50px;">To:
                            ...
                            font-style: normal;
                            font-weight: 700;
                            line-height: normal;">FULGENCIO “JUN” C. DELA CUESTA JR.</span>
                        </p>
                        ...
                        font-weight: 400;
                        line-height: normal;
                        margin-left: 27px;">Board of member</p>
                        ...
                        margin-top: 50px;">This is certify that
                            <input type="text"
                                ...
                                id="name" placeholder="NAME OF APPLICANT" style="color: #000;
                            font-family: Caladea;
                            font-size: 19px;
                            font-style: normal;
                            font-weight: 400;
                        ...
                        margin-top: 50px;">This certification is being issued upon the request of above
                            mention name for the purpose/s of compliance to <input type="text"
                                value="<?php echo $certofindigency['purpose']?>" id="purpose" placeholder="PURPOSE"
                                style=" color: #000;
                            font-family: Caladea;
                            font-size: 19px;
                            font-style: normal;
            ...
            <div class="modal-layer-indigency-self">
                ...
                <div class="input-indigency-self">
                    ...
                    <div class="label111">
                        ...
                        <input type="text" name="street" id="street_self1" class="street" placeholder="Street name">
...
<script>
    ...
    const modaleditLink = document.querySelector('.modal-editIndigency_forself');
